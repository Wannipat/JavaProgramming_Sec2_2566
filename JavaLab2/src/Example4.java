...
public class Example4 {
	...
	public static void main(String[] args) {
		...
		float unitPerPrice = Float.parseFloat(JOptionPane.showInputDialog("Input price per unit : "));
		double totalPrice = unitPrice * unitPerPrice;
		double vat = totalPrice +(totalPrice*7/100);
		//show message from dialog box
		JOptionPane.showMessageDialog(null, "totalPrice is "
